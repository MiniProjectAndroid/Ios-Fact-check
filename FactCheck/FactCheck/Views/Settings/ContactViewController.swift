...
class ContactViewController: UIViewController {
 ...
 extension ContactViewController:UITableViewDelegate,UITableViewDataSource{
     ...
     func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
         let cell = tblView.dequeueReusableCell(withIdentifier: "ContactCell", for: indexPath) as! ContactTableViewCell
         if isFilter{
     ...
     func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        // let cell = tblView.cellForRow(at: indexPath) as? ContactTableViewCell
         //print(cell)
 ...
 extension ContactViewController:UITextFieldDelegate{
     func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool {
         let searchText:String = textField.text! + string
         print(searchText)
         if searchText == "" {
             isFilter = false
             tblView.reloadData()
